...
#ifndef ACKERMANN_DRIVE_CONTROLLER__ACKERMANN_DRIVE_CONTROLLER_HPP_
#define ACKERMANN_DRIVE_CONTROLLER__ACKERMANN_DRIVE_CONTROLLER_HPP_
...
#include "ackermann_drive_controller/steering_limiter.hpp"
#include "ackermann_drive_controller/traction_limiter.hpp"
...
protected:
  ...
  control_toolbox::Pid traction_pid_;
  control_toolbox::Pid steering_pid_;

  std::array<double, 5> traction_pid_params_;
  std::array<double, 5> steering_pid_params_;
  ...
  double steering_transmision_ratio_ = 1.0;
